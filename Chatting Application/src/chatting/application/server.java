...
import java.net.*;  //for server socket programing
...
//Jlabel is a GUI display area for a string of text,image or both
    ...
    public static void main(String[] args) {
        new server();//class ke run hote hi main method call hota h and
        ...
        try{
            ...
            // infinitely chalana h and sare messages accept karna h
            while(true) {
